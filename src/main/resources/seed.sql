...
INSERT INTO person(id, email, first_name, last_name, password_id, row_timestamp)
VALUES ('test1@test.com', 'john', 'doe', 1, 'now');
...
INSERT INTO provider(first_name, last_name, phone, location_id, row_timestamp) VALUES ('Rich', 'Schwepe', '345-563-2342', 1, 'now');
