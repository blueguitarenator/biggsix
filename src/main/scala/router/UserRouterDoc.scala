...
trait UserRouterDoc {
    ...
    @ApiOperation(value = "Get a user by id", httpMethod = "GET", response = classOf[PersonRow])
    ...
    @ApiOperation(value = "Get all the users", httpMethod = "GET", response = classOf[List[PersonRow]])
